...
export const CarInput = ( { label, rules, note, ...props } ) => {
    ...
    return (
        <>
            <Typography fontSize={ TextStyles.textSm.medium } color={ ColorStyles.gray[ 700 ] } mb="6px" paragraph>
            ...
            { helperText ? (
                ...
                <Typography fontSize={ TextStyles.textSm.normal } mt={ 0.5 } mb={ 0 } paragraph>
                    { note }
                </Typography>
            ) : (
                ""
